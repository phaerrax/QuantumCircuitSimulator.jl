...
"""
    tem_mpo(code::AbstractString,noiseλ,noiseλλ;kwargs...)
...
a sparse Pauli-Lindblad noise model generated by the parameters `noiseλ` and `noiseλλ`.
...
function tem_mpo(code::AbstractString, noiseλ, noiseλλ; kwargs...)
    ...
    𝓝⁻¹ = noise_inverse_mpo(sites, noiseλ, noiseλλ)
